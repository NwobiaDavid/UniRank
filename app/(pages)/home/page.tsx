...
const page = () => {
  ...
  return (
    <div className=' w-full h-[80dvh] flex flex-col justify-center items-center px-24 ' >
      ...
      <div className='h-[90%] w-full  p-24 flex justify-center items-center flex-col ' >
        <div className="mb-16 w-[70%] xl:w-[80%] text-center flex flex-col justify-center items-center ">
          ...
          <p className='w-full  '>
            <h1 className="text-lg">Welcome to the UniRank! Here are a few things to keep in mind before you start:</h1>
            {/* <br />
            ...
            <h1 className="text-lg" >It is advisable to read through the rules before you take the test. </h1>
            <h1 className="text-lg" >Good luck, and give it your best shot!</h1>
          </p>
        </div>
